# Adverse Incorporation or Displacement?
### Testing the Structural Persistence of Informality and Wage Pass-Through in India's Textile Industry
...
2.  **Structural Monopsony**: There is a **statistical zero wage pass-through** ($\beta = 0.013$, $p=0.857$) from formal gains to informal workers. Lead firms capture 100% of productivity rents.
3.  **Extreme Persistence**: Informal employment exhibits a persistence coefficient of **0.905** ($p < 0.001$), suggesting that informality is a self-perpetuating structural feature rather than a transitional friction.
...
## 🛠️ Methodology & Data
- **Data**: State-Industry pooled panel (N=152) constructed from ASI, SUNAE 2010-11 (NSS 67th Round), UNAE 2015-16 (NSS 73rd Round), and ASUSE (2010--2024).
