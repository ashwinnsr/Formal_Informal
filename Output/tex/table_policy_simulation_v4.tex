\begin{table}[ht]
  ...
  \begin{tabular}{lccc}
    ...
    \midrule
    Zero Enforcement ($E_s$ = 0) & -2.85 & 4.68 & 1.83 \\
    Double Enforcement ($E_s$ = 0.45) & 2.43 & -3.01 & -1.79 \\
    Informal Wage Floor (+20\%) & 0.26 & 6.39 & 0.00 \\
    Double $E_s$ + Wage Floor & 2.12 & 2.41 & -1.76 \\
    \bottomrule
  \end{tabular}
  \medskip
